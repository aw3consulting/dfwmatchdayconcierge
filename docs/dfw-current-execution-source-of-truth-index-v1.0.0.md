# DFW Current Execution Source-of-Truth Index v1.0.0
...
Status: ACTIVE SOURCE-OF-TRUTH INDEX
...
| File | Standing | Role |
|---|---|---|
| `docs/dfw-ai-governed-premium-website-builder-market-research-and-standards-map-v1.0.1.md` | Active | Research map with unverified rows excluded from execution authority. |
...
| File | Standing | Role |
|---|---|---|
| `docs/audits/dfw-ai-governed-premium-website-builder-independent-audit-report-v1.0.0.md` | Active | Independent audit report. |
| `docs/audits/dfw-ai-governed-premium-website-builder-correction-register-v1.0.0.md` | Active | Correction register. |
| `docs/audits/dfw-public-surface-boundary-and-route-status-register-v1.0.0.md` | Active | Public route and surface classification. |
| `docs/audits/dfw-rejected-prototype-index-v1.0.0.md` | Active | Rejected prototype quarantine index. |
| `docs/audits/dfw-qr-domain-activation-boundary-record-v1.0.0.md` | Active | QR and final-domain boundary record. |
| `docs/audits/dfw-section-review-acceptance-criteria-v1.0.0.md` | Active | Measurable review criteria. |
...
| `docs/audits/dfw-superseded-execution-surface-total-deactivation-zero-drift-verification-record-v1.0.0.md` | Active | Zero-drift verification record. |
| `docs/audits/dfw-superseded-execution-surface-total-deactivation-final-closure-addendum-v1.0.0.md` | Active | Final closure addendum confirming the last unresolved superseded surface is now deactivated. |
...
Existing public route files are classified through:

`docs/audits/dfw-public-surface-boundary-and-route-status-register-v1.0.0.md`

They may not be used as skeleton content sources and may not bypass the section state machine.

## 7. Rejected and Superseded Artifacts

| Artifact | Standing | Use rule |
|---|---|---|
| `docs/prototypes/homepage-v1.0.4/review.html` | Rejected / hard-failed | Audit evidence only. Not execution basis. |
...
| `docs/dfw-ai-governed-premium-website-builder-market-research-and-standards-map-v1.0.0.md` | Old research map carried skeleton-first next-execution wording and was superseded by v1.0.1. | Superseded / historical audit trace only. | Historical audit trace only. Not executable. Not current authority. May not authorize skeleton rendering. | `docs/dfw-ai-governed-premium-website-builder-market-research-and-standards-map-v1.0.1.md` |

## 9. Resolved Superseded Surface

`docs/dfw-ai-governed-premium-website-builder-market-research-and-standards-map-v1.0.0.md` was the only remaining unresolved superseded surface. It now contains a top-of-file supersession/deactivation notice before the original title and points to the active replacement:
...
`SOURCE-OF-TRUTH INDEX UPDATED / ALL IDENTIFIED SUPERSEDED EXECUTION SURFACES LISTED AS DEACTIVATED / NEXT ACTION LIMITED TO OPTION-SELECTION REVIEW AFTER USER AUTHORIZATION / SKELETON RENDERING REMAINS BLOCKED UNTIL USER OPTION SELECTION IS RECORDED`.
